...
if __name__ == '__main__':
    ...
    num_workers = [1, 2, 4, 8, 12, 16, 24, 32, 48, 64]
    out = []
    ...
    for ds in datasets:
        ...
        subprocess.run(['erlc', 'erlang/totientrange.erl'])
        result = subprocess.run(['go', 'run', 'erlang/seqTotientRange.erl', '1', str(ds)],
    ...
    with open('DPT_coursework_erlang_logs.txt', 'w+') as file:
        for log in out:
            file.write(log)
